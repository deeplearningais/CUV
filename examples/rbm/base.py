...
from helper_classes import UnitType, CDType, LearnRateSchedule, LoadType, EvalStartType
        ...
        try:
            ...
            for iter in xrange(iterstart, itermax):
                ...
                if self.cfg.cd_type ==  CDType.cdn:
                    self.cdnStep(layernum)
                elif self.cfg.cd_type ==  CDType.pcd:
                    self.pcdStep(layernum)
