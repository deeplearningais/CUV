...
namespace cuv{
	 ...
	 * @param factA the result of A*B is multiplied with this factAB and then added to factC*C
	 * @param factB the result of A*B is multiplied with this factAB and then added to factC*C
	 */
